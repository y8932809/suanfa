 ...
 */
package com.ykf.suanfa.map.geohash;
...
public class GeoHashOld1 {
    private LocationBean location;
    /**
     * 1 2500km;2 630km;3 78km;4 30km
     * 5 2.4km; 6 610m; 7 76m; 8 19m
     */
    private int hashLength = 2; //经纬度转化为geohash长度
    ...
    public GeoHashOld1(double lat, double lng) {
...
//    private double lng;//经度[-180,180]
    public static void main(String[] args) {
        ...
        GeoHashOld1 g = new GeoHashOld1(39.842982,116.37732);
      //  GeoHashOld1 g = new GeoHashOld1(39.842511,116.385728);
